...
Bibi.SiteHref = "https://to-love-scan.com/";
Bibi.WelcomeMessage = 'Bienvenue sur le reader de la To Love Scan!';
...
B.initialize = function() {
    O.applyTo(B, {
        ...
        Package:   { Path: "", Dir: "",
            Metadata: { "identifier": "", "title": "", "creators": [], "publishers": [], "languages": ['jp'] },
...
L.loadBook = function(PathOrData) {
    ...
    I.note('Chargement de l\'Epub...');
    O.log("Initializing Book...", "*:");
    return new Promise(function(resolve, reject) {
        L.loadBook.resolve = function() {
            resolve.apply(L.loadBook, arguments);
            //TODO cacher notifier ici, pas dans un timeout
...
L.processPackageDocument = function(Doc) {
    ...
    forceWritingMode = S["force-writing-mode"];
    if(forceWritingMode) {
        B.WritingMode = forceWritingMode
    } else if(/^(zho?|chi|kor?|ja|jpn)$/.test(B.Language)) {
...
L.onLoadItem = function(Item) {
    ...
    I.note("Chargement... (" + (L.LoadedItems) + "/" + R.Items.length + " pages téléchargées.)");
